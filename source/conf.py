...
# ones.
extensions = ['sphinx.ext.mathjax','sphinx_sitemap', 'sphinx_multiversion', 'sphinx_markdown_tables', 'recommonmark']
...
#}
source_suffix = [
    '.rst','.md', '.txt', '.tex', '.rst.txt', '.rst.tex',
    # '.txt': 'markdown',
    # '.md',
]
