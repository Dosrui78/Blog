...
![img](https://github.com/Dosrui78/Blog-Images/blob/master/4.21.png?raw=true) 

这种带翻页的，打开fiddler，查看翻页会有哪些参数变化，然后进行堆栈查找

![img](https://github.com/Dosrui78/Blog-Images/blob/master/4.21-1.png?raw=true)

可发现m是变化的，cookie是不变的，于是可以确定是参数m动了手脚，因为返回数据是json格式的，我们可以打XHR去观察。

![img](https://github.com/Dosrui78/Blog-Images/blob/master/4.21-2.png?raw=true)
...
在控制台运行得到如下结果（前提是要去掉后面location那些杂鱼）
...
![4.23.png](https://github.com/Dosrui78/Blog-Images/blob/master/4.23.png?raw=true)
...
![img](https://github.com/Dosrui78/Blog-Images/blob/master/4.24-1.png?raw=true)

如果不是这个界面，删除Application里cookie的sign重头来一次直到进入到这个界面，因为和时间有关，多半是date，于是搜索date就可以找到加密参数的位置，然后全部打上断点。

![img](https://github.com/Dosrui78/Blog-Images/blob/master/4.24-2.png?raw=true)

再f8发现出现debugger，可以用never pause过了；然后单步调试到如下界面：

![4.24-3.png](https://github.com/Dosrui78/Blog-Images/blob/master/4.24-3.png?raw=true)
...
![4.24-4.jpg](https://github.com/Dosrui78/Blog-Images/blob/master/4.24-4.jpg?raw=true)
